...
<div class="card" style="width: 100%">
  <div class="card-body">
    ...
    <tbody >
    @foreach($seminarios as $item)
    <tr>
      <th scope="row">{{$item->id_seminario}}</th>
      <td>{{$item->name_seminario}}</td>
      ...
      <a href="{{route('admin.users.eliminarseminario', $item->id)}}" onclick="return confirm('¿Desea Eliminar Este Diplomado?')"><img src="https://img.icons8.com/color/48/000000/cancel.png" height="30" width="30"></a>
      </td>
