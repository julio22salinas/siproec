...
<div class="card" style="width: 100%">
  <div class="card-body">
    <h5 class="card-title">Diplomado</h5>
    ...
    <tr>
      <th scope="row">{{$item->id_diplomado}}</th>
      <td>{{$item->name_diplomado}}</td>
      ...
      <a href="{{route('admin.users.eliminardiplo', $item->id)}}" onclick="return confirm('¿Desea Eliminar Este Diplomado?')"><img src="https://img.icons8.com/color/48/000000/cancel.png" height="30" width="30"></a>
      </td>
